                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">     ضمانات تكنو وان
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">جميع  ضمانات تكنو وان
                                    </h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <a href="{{route('admin.warranty.create')}}"
                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">إضافة ضمان جديد</a>
                                            </div>
                                        </div>
                                        <table
